  ...
  return (
    <>
      <form onSubmit={handleSubmit}>
        ...
        <Input label="Estado de exhibicion" value={form.estadoExhibicion} onChange={update("estadoExhibicion")} required />
        <Input label="Codigo QR de verificacion" value={form.codigoQR} onChange={update("codigoQR")} required />
